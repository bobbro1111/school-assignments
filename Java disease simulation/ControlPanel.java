...
public class ControlPanel extends JPanel {
	...
	*/
	...
	public ControlPanel() {
		...
		panels[4] = new SliderMovement(
			Layout.SLIDER_PANEL_LEFT, Layout.SLIDER_PANEL_ROW3
		);
		add(panels[4]);
		
		
		panels[5] = new SliderMorbidity(
